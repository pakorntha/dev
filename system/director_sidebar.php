<?php
if (!function_exists('sis4_director_sidebar_link_class')) {
    function sis4_director_sidebar_link_class(bool $active): string
    {
        return $active
...
if (!function_exists('sis4_teacher_sidebar_render')) {
    function sis4_direcetor_sidebar_render(string $displayName, string $initial, string $roleText = 'ผู้อำนวยการ', string $logoutPath = '../../system/logout.php', string $extraAsideClass = ''): void
    {
        ...
        <aside class="<?= htmlspecialchars($asideClass, ENT_QUOTES, 'UTF-8') ?>">
            ...
            <nav class="flex-1 overflow-y-auto no-scrollbar px-3 py-4 space-y-6 text-sm">
                <div>
                    <a href="home.php" class="<?= sis4_director_sidebar_link_class($dashboardActive) ?>">
                ...
                <div>
                    ...
                    <ul class="space-y-1">
                        <li>
                            <a href="homework.php" class="<?= sis4_director_sidebar_link_class($homeworkActive) ?>">
                ...
                <div>
                    ...
                    <ul class="space-y-1">
                        <li>
                            <a href="incoming.php" class="<?= sis4_director_sidebar_link_class($documentsActive) ?>">
                                <i class="fa-solid fa-inbox w-5 text-center"></i>
                                หนังสือรับ
                            </a>
                        </li>
                ...
                <div>
                    ...
                    <ul class="space-y-1">
                        <li>
                            <a href="checking.php" class="<?= sis4_director_sidebar_link_class($checkingActive) ?>">
                                <i class="fa-solid fa-user-clock w-5 text-center"></i>
                                ลงเวลาปฏิบัติงาน
                            </a>
                        </li>
                        <li><a href="leave.php" class="<?= sis4_director_sidebar_link_class($leaveActive) ?>"><i
                                    class="fa-regular fa-calendar-minus w-5 text-center"></i> การลา</a></li>
                        <li><a href="official_trip.php"
                                class="<?= sis4_director_sidebar_link_class($officialTripActive) ?>"><i
                ...
                <div>
                    ...
                    <ul class="space-y-1">
                        <li>
                            <a href="student_list.php" class="<?= sis4_director_sidebar_link_class($studentListActive) ?>">
                                <i class="fa-solid fa-users w-5 text-center"></i>
                                นักเรียนและห้องเรียน
                            </a>
                        </li>
                        <li>
                            <a href="atten.php" class="<?= sis4_director_sidebar_link_class($attendanceActive) ?>">
                                <i class="fa-solid fa-chalkboard-user w-5 text-center"></i>
                                การมาเรียนนักเรียน
                            </a>
                        </li>
                        <li><a href="lession_plan.php" class=" <?= sis4_director_sidebar_link_class($lessionPlanActive) ?>"><i class="fa-solid fa-book-open w-5 text-center"></i> แผนการสอน</a></li>
                        <li><a href="supervision.php" class=" <?= sis4_director_sidebar_link_class($supervisionActive) ?>"><i class="fa-solid fa-eye w-5 text-center"></i> นิเทศการสอน</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-1">
                        <li>
                            <a href="calendar.php" class="<?= sis4_director_sidebar_link_class($calendarActive) ?>">
